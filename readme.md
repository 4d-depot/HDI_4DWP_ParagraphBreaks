# HDI_4DWP_ParagraphBreaks 

Manage special characters in [4D Write Pro](https://us.4d.com/4D-write-pro) documents returned by formulas (4D v18 R4)

Find more information on the [blog post](https://blog.4d.com/4d-write-pro-more-control-when-using-formulas/).
